...
public class A2 {
    ...
    public static void solve() {
        ...
        int n = st.length();
        char first = st.charAt(0), last = st.charAt(n - 1);
        if(first == last){
        	out.println(first + " " + (st.substring(1, n-1)) + " " + last);
        	return;
        }
        ...
        if(first == 'a'){
        	for(int i = 1; i < n - 1; i++){
        		if(st.charAt(i) == 'b'){
        			out.println(st.substring(0, i) + " " + st.substring(i, n-1) + " " + last);
        			return;
        		}
        	}
        	
        	// no b if found
        	out.println(st.substring(0, n - 2) + " " + "a" + " " + last);
        	return;
        }
        ...
        if(first == 'b'){
        	for(int i = 1; i < n - 1; i++){
        		if(st.charAt(i) == 'a'){
        			out.println(st.substring(0, i) + " " + st.charAt(i) + " " + st.substring(i+1, n));
        			return;
        		}
        	}
