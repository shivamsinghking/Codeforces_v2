...
public class D {
    ...
    public static void solve() {
        ...
        int zero = 0, ones = 0;
        for(int i = 0; i < n; i++){
        	if(st.charAt(i) == '1') ones++;
        	else zero++;
        }
        
        // cntLeftEle = no. of element left to X
        // cntRightEle = no. of element right to X
        int cntLeftEle = (1 << ones) - 1;
        int cntRightEle = (1 << zero) - 1;
        
        for(int i = cntLeftEle + 1; (1 << n) - i >= cntRightEle; i++){
          out.print(i + " ");	
        }
